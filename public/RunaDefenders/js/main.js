...
function initThreeScene() {
    ...
    // --- ¡CAMBIO REALIZADO! ---
    // Se rota la geometría en el eje Y. Esto alinea la textura del GIF para que
    // mire hacia "adelante" en lugar de hacia un lado cuando se aplica a la esfera.
    orbGeometry.rotateY(-Math.PI / 2); // Rotar -90 grados (PI/2 radianes)
...
function gameLoop() {
    ...
    } else if (gameState !== 'level_complete' && gameState !== 'paused') {
